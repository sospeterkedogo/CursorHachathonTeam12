                ...
                <div className="lg:w-1/3 space-y-8">
                    ...
                    <div className="flex items-center gap-4 py-4 px-6 luxury-card border-emerald-500/20 bg-emerald-500/10 dark:border-emerald-500/10 dark:bg-emerald-500/5 mb-8">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-[10px] text-neutral-500 dark:text-neutral-400 font-light uppercase tracking-widest">Add to Home Screen for easy access.</p>
                        </div>
                    </div>
                    ...
                    {GETTING_STARTED.map((item, i) => (
                        <div key={i} className="space-y-6 relative group">
                            ...
                            <div className="w-12 h-12 rounded-xl bg-black/5 border-black/5 dark:bg-white/5 dark:border-white/5 border flex items-center justify-center relative z-10 group-hover:border-emerald-500/30 transition-colors">
                                <item.icon className="w-6 h-6 text-black/60 dark:text-white/60 group-hover:text-emerald-500 transition-colors" />
                            ...
                            <p className="text-xs text-neutral-400 dark:text-neutral-500 leading-relaxed font-light relative z-10 group-hover:text-black dark:group-hover:text-white transition-colors">{item.desc}</p>
                        </div>
                    ))}
                </div>
            </div>
